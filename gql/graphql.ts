...
export type Artist = Entity & Node & {
  __typename?: 'Artist';
...
export type ArtistCreateInput = {
  ...
  songs?: InputMaybe<ArtistSongsCreateManyInlineInput>;
...
export type ArtistManyWhereInput = {
  ...
  /** All values that are not contained in given list. */
  nationality_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** All values not starting with the given string. */
...
export type ArtistSongs = Song;

export type ArtistSongsConnectInput = {
  Song?: InputMaybe<SongConnectInput>;
};

export type ArtistSongsCreateInput = {
  Song?: InputMaybe<SongCreateInput>;
};

export type ArtistSongsCreateManyInlineInput = {
  /** Connect multiple existing ArtistSongs documents */
  connect?: InputMaybe<Array<ArtistSongsWhereUniqueInput>>;
  /** Create and connect multiple existing ArtistSongs documents */
  create?: InputMaybe<Array<ArtistSongsCreateInput>>;
};

export type ArtistSongsCreateOneInlineInput = {
  /** Connect one existing ArtistSongs document */
  connect?: InputMaybe<ArtistSongsWhereUniqueInput>;
  /** Create and connect one ArtistSongs document */
  create?: InputMaybe<ArtistSongsCreateInput>;
};

export type ArtistSongsUpdateInput = {
  Song?: InputMaybe<SongUpdateInput>;
};

export type ArtistSongsUpdateManyInlineInput = {
  /** Connect multiple existing ArtistSongs documents */
  connect?: InputMaybe<Array<ArtistSongsConnectInput>>;
  /** Create and connect multiple ArtistSongs documents */
  create?: InputMaybe<Array<ArtistSongsCreateInput>>;
  /** Delete multiple ArtistSongs documents */
  delete?: InputMaybe<Array<ArtistSongsWhereUniqueInput>>;
  /** Disconnect multiple ArtistSongs documents */
  disconnect?: InputMaybe<Array<ArtistSongsWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing ArtistSongs documents */
  set?: InputMaybe<Array<ArtistSongsWhereUniqueInput>>;
  /** Update multiple ArtistSongs documents */
  update?: InputMaybe<Array<ArtistSongsUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple ArtistSongs documents */
  upsert?: InputMaybe<Array<ArtistSongsUpsertWithNestedWhereUniqueInput>>;
};

export type ArtistSongsUpdateManyWithNestedWhereInput = {
  Song?: InputMaybe<SongUpdateManyWithNestedWhereInput>;
};

export type ArtistSongsUpdateOneInlineInput = {
  /** Connect existing ArtistSongs document */
  connect?: InputMaybe<ArtistSongsWhereUniqueInput>;
  /** Create and connect one ArtistSongs document */
  create?: InputMaybe<ArtistSongsCreateInput>;
  /** Delete currently connected ArtistSongs document */
  delete?: InputMaybe<Scalars['Boolean']['input']>;
  /** Disconnect currently connected ArtistSongs document */
  disconnect?: InputMaybe<Scalars['Boolean']['input']>;
  /** Update single ArtistSongs document */
  update?: InputMaybe<ArtistSongsUpdateWithNestedWhereUniqueInput>;
  /** Upsert single ArtistSongs document */
  upsert?: InputMaybe<ArtistSongsUpsertWithNestedWhereUniqueInput>;
};

export type ArtistSongsUpdateWithNestedWhereUniqueInput = {
  Song?: InputMaybe<SongUpdateWithNestedWhereUniqueInput>;
};

export type ArtistSongsUpsertWithNestedWhereUniqueInput = {
  Song?: InputMaybe<SongUpsertWithNestedWhereUniqueInput>;
};

export type ArtistSongsWhereInput = {
  Song?: InputMaybe<SongWhereInput>;
};

export type ArtistSongsWhereUniqueInput = {
  Song?: InputMaybe<SongWhereUniqueInput>;
};
...
export type ArtistUpdateInput = {
  ...
  name?: InputMaybe<Scalars['String']['input']>;
  nationality?: InputMaybe<Scalars['String']['input']>;
  songs?: InputMaybe<ArtistSongsUpdateManyInlineInput>;
};
...
export type Genre = Entity & Node & {
  __typename?: 'Genre';
  artists: Array<GenreArtists>;
  /** The time the document was created */
  createdAt: Scalars['DateTime']['output'];
  /** User that created this document */
  createdBy?: Maybe<User>;
...
export type GenreArtists = Artist;

export type GenreArtistsConnectInput = {
  Artist?: InputMaybe<ArtistConnectInput>;
};

export type GenreArtistsCreateInput = {
  Artist?: InputMaybe<ArtistCreateInput>;
};

export type GenreArtistsCreateManyInlineInput = {
  /** Connect multiple existing GenreArtists documents */
  connect?: InputMaybe<Array<GenreArtistsWhereUniqueInput>>;
  /** Create and connect multiple existing GenreArtists documents */
  create?: InputMaybe<Array<GenreArtistsCreateInput>>;
};

export type GenreArtistsCreateOneInlineInput = {
  /** Connect one existing GenreArtists document */
  connect?: InputMaybe<GenreArtistsWhereUniqueInput>;
  /** Create and connect one GenreArtists document */
  create?: InputMaybe<GenreArtistsCreateInput>;
};

export type GenreArtistsUpdateInput = {
  Artist?: InputMaybe<ArtistUpdateInput>;
};

export type GenreArtistsUpdateManyInlineInput = {
  /** Connect multiple existing GenreArtists documents */
  connect?: InputMaybe<Array<GenreArtistsConnectInput>>;
  /** Create and connect multiple GenreArtists documents */
  create?: InputMaybe<Array<GenreArtistsCreateInput>>;
  /** Delete multiple GenreArtists documents */
  delete?: InputMaybe<Array<GenreArtistsWhereUniqueInput>>;
  /** Disconnect multiple GenreArtists documents */
  disconnect?: InputMaybe<Array<GenreArtistsWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing GenreArtists documents */
  set?: InputMaybe<Array<GenreArtistsWhereUniqueInput>>;
  /** Update multiple GenreArtists documents */
  update?: InputMaybe<Array<GenreArtistsUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple GenreArtists documents */
  upsert?: InputMaybe<Array<GenreArtistsUpsertWithNestedWhereUniqueInput>>;
};

export type GenreArtistsUpdateManyWithNestedWhereInput = {
  Artist?: InputMaybe<ArtistUpdateManyWithNestedWhereInput>;
};

export type GenreArtistsUpdateOneInlineInput = {
  /** Connect existing GenreArtists document */
  connect?: InputMaybe<GenreArtistsWhereUniqueInput>;
  /** Create and connect one GenreArtists document */
  create?: InputMaybe<GenreArtistsCreateInput>;
  /** Delete currently connected GenreArtists document */
  delete?: InputMaybe<Scalars['Boolean']['input']>;
  /** Disconnect currently connected GenreArtists document */
  disconnect?: InputMaybe<Scalars['Boolean']['input']>;
  /** Update single GenreArtists document */
  update?: InputMaybe<GenreArtistsUpdateWithNestedWhereUniqueInput>;
  /** Upsert single GenreArtists document */
  upsert?: InputMaybe<GenreArtistsUpsertWithNestedWhereUniqueInput>;
};

export type GenreArtistsUpdateWithNestedWhereUniqueInput = {
  Artist?: InputMaybe<ArtistUpdateWithNestedWhereUniqueInput>;
};

export type GenreArtistsUpsertWithNestedWhereUniqueInput = {
  Artist?: InputMaybe<ArtistUpsertWithNestedWhereUniqueInput>;
};

export type GenreArtistsWhereInput = {
  Artist?: InputMaybe<ArtistWhereInput>;
};

export type GenreArtistsWhereUniqueInput = {
  Artist?: InputMaybe<ArtistWhereUniqueInput>;
};
...
export type GenreCreateInput = {
  artists?: InputMaybe<GenreArtistsCreateManyInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
...
export type GenreManyWhereInput = {
  ...
  _search?: InputMaybe<Scalars['String']['input']>;
  /** All values in which the union is empty */
  artists_empty?: InputMaybe<Scalars['Boolean']['input']>;
  /** Matches if the union contains at least one connection to the provided item to the filter */
  artists_some?: InputMaybe<GenreArtistsWhereInput>;
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than the given value. */
  createdAt_gt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than or equal the given value. */
...
export type GenreUpdateInput = {
  artists?: InputMaybe<GenreArtistsUpdateManyInlineInput>;
...
export type ScheduledOperationAffectedDocument = Artist | Asset | Genre | Song;
...
export type SongCreateInput = {
  artist?: InputMaybe<ArtistCreateOneInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  genres?: InputMaybe<GenreCreateManyInlineInput>;
  length?: InputMaybe<Scalars['String']['input']>;
  mp3: Scalars['String']['input'];
  title: Scalars['String']['input'];
  updatedAt?: InputMaybe<Scalars['DateTime']['input']>;
};
...
export type SongManyWhereInput = {
  ...
  /** All values that are contained in given list. */
  length_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** Any other value that exists and is not equal to the given value. */
  ...
  /** All values that are not contained in given list. */
  length_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** All values not starting with the given string. */
  length_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  /** All values starting with the given string. */
  length_starts_with?: InputMaybe<Scalars['String']['input']>;
  mp3?: InputMaybe<Scalars['String']['input']>;
  /** All values containing the given string. */
  mp3_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values ending with the given string. */
  mp3_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are contained in given list. */
  mp3_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** Any other value that exists and is not equal to the given value. */
  mp3_not?: InputMaybe<Scalars['String']['input']>;
  /** All values not containing the given string. */
  mp3_not_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values not ending with the given string */
  mp3_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are not contained in given list. */
  mp3_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** All values not starting with the given string. */
  mp3_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  /** All values starting with the given string. */
  mp3_starts_with?: InputMaybe<Scalars['String']['input']>;
  publishedAt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than the given value. */
  publishedAt_gt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than or equal the given value. */
...
export type SongUpdateInput = {
  artist?: InputMaybe<ArtistUpdateOneInlineInput>;
  genres?: InputMaybe<GenreUpdateManyInlineInput>;
  length?: InputMaybe<Scalars['String']['input']>;
  mp3?: InputMaybe<Scalars['String']['input']>;
  title?: InputMaybe<Scalars['String']['input']>;
...
export type GetAllSongsQuery = { __typename?: 'Query', songs: Array<{ __typename?: 'Song', id: string, title: string, length?: string | null, mp3: string, artist?: { __typename?: 'Artist', name: string, nationality?: string | null, description: { __typename?: 'RichText', html: string } } | null, genres: Array<{ __typename?: 'Genre', id: string, title: string }> }> };


export const GetAllSongsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetAllSongs"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"songs"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"length"}},{"kind":"Field","name":{"kind":"Name","value":"mp3"}},{"kind":"Field","name":{"kind":"Name","value":"artist"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"nationality"}},{"kind":"Field","name":{"kind":"Name","value":"description"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"html"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"genres"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}}]}}]}}]}}]} as unknown as DocumentNode<GetAllSongsQuery, GetAllSongsQueryVariables>;